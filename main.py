...
Seleccione: """)
    if eleccion == "1":
        nombre = input("Codigo del producto: ")
        precio = float(input("Precio del producto: "))
        peso = float(input("Peso(kg) del producto: "))
        cantidad_vendida = 0.0
        nombres.append(nombre)
        precios.append(precio)
        cantidades_vendidas.append(cantidad_vendida)
    elif eleccion == "2":
        nombre_articulo = input("Codigo del artículo que se vende: ")
        ...
        print("+--------------------+----------+----------+-----------+----------+")
        print("|CODIGO              |CANT.     |PRECIO    |PESO(KG)   |IMPORTE   |")
        print("+--------------------+----------+----------+-----------+----------+")
        indice = 0
        total = 0
        while indice < len(nombres):
            ...
            importe = precio * cantidad_vendida+(peso*1200)#cada kg equivale a 1200 
            print("|{:<20}|{:>10.2f}|{:>10.2f}|{:>10.2f}|{:>10.2f}|".format(
                nombre, cantidad_vendida, precio,peso, importe))
            print("+--------------------+----------+----------+-----------+----------+")
